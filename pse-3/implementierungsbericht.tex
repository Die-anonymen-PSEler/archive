...
\subsubsection{Hinzugefügte Methoden}
\begin{description}
	\item[Konstruktor] Ein Konstruktor wurde eingefügt der das Erstellen eines Setting-Objektes mit Standardwerten erlaubt.
\end{description}
...
\subsubsection{Hinzugefügte Methoden}
\begin{description}
	\item[Konstruktor] Ein Konstruktor wurde eingefügt der das Erstellen eines Statistic-Objektes mit Standardwerten erlaubt.
\end{description}
