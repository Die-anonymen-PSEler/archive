...
Lambdor, der Vollstrecker, hat dich entführt und in ein Haus mit vielen magischen Räumen gesperrt, deren Türen verschlossen sind. Um entkommen zu können musst du die Türen öffnen, dafür brauchst besondere Metallstücke, diese hat Lambdor jedoch zerstört. Du kannst sie wieder herstellen, dafür musst du aber zunächst die Maschinen zusammenbauen, mit denen du sie herstellen kannst. Glücklicherweise hilft dir Lambdalino, der kleine Bruder von Lambdor, dabei. Er zeigt dir wie du die Maschinen zusammenbauen musst und wie du die Metallstücke herstellen kannst. So kannst du es schaffen, aus dem Wirrwarr der Räume zu entkommen.
...
\begin{falist}[resume]
	...
	\begin{falist}
		...
		\item \label{fa:spielerprofile_loeschen} \textbf{Löschen von Spielerprofilen} Das Löschen eines Spielerprofils erfolgt über die Benutzerverwaltung.
		\item \label{fa:spielerprofile_wechseln} \textbf{Wechseln zu Spielerprofilen} Das Wechseln eines Spielerprofils ist möglich über die Benutzerverwaltung.
...
\begin{falist}[resume]
	\item \label{fa:level} \textbf{Level} Ein Level (fill me in)
	...
	\begin{falist}
		\item \textbf{Aufnehmen von Spielelementen}
		\item \textbf{Abgabe für die Levelquests}
	\end{falist}
\end{falist}
...
\begin{falist}[resume]
	...
	\item \textbf{Animierte Auswertung der Maschinenkonstellation}
\end{falist}
