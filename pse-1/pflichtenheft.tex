...
Zur Steuerung der Spielfigur in den einzelnen Leveln werden im unteren Teil des Bildschirms insgesamt 5 Buttons eingeblendet , die sich in 2 Gruppen aufteilen.\\
Die Positionierung dieser Buttons kann Profil spezifisch geändert werden, dabei gibt es jedoch nur 2 Wahlmöglichkeiten.\\

\begin{enumerate}
	\item Gruppe 1:\\
	Die erste Gruppe an Buttons besteht aus 2 Buttons, durch diese kann der Spieler die Spielfigur nach Rechts und Links bewegen.\\
	Die Spielfigur bewegt sich dabei solange in die jeweilige Richtung wie der Spieler den Button drückt.\\
	Diese Buttongruppe ist standardmäßig in der linken unteren Ecke des Bildschirms.\\
	Der Spieler kann immer nur einender beiden Buttons , aber nie beide zur selben Zeit drücken.\\
	
	\item Gruppe 2:\\
	Die zweite Gruppe an Buttons besteht aus 3 Buttons, diese dienen zum einen der Interaktion der Spielfigur mit den Spielobjekten die es platzieren muss und zum anderen der Funktion zu Springen und die Spielfigur sich ducken zu lassen.\\
	Der Button zur Interaktion mit den Spielobjekten hat 2 Funktionen, zum einen kann der Spieler ein Spielobjekt das in blick Richtung direkt neben der Spielfigur liegt aufheben, und trägt es somit, zum anderen kann  die Spielfigur falls sie ein Spielobjekt trägt, dieses in Blickrichtung in ein benachbartes Feld ablegen. Diese Aktionen können nicht parallel zu einer der anderen drei Aktionen (Bewegen, Springen, Ducken) ausgeführt werden, die Spielfigur muss stehen.\\
	...
	Der Ducken-Button lässt die Spielfigur ducken, dies führt zu einer Verringerung ihrer Größe , was insbesondere wenn sie ein Objekt trägt hilfreich sein kann. Die Spielfigur kann parallel zum ducken sich nur bewegen, nicht aber springen oder ein Objekt aufnehmen oder ablegen.\\
	
	\item Im folgenden sehen sie eine ungefähre Darstellung der Steuerung. Dia alternative die Profil spezifisch gewählt werden kann, sieht eine Vertauschung der beiden Button Gruppen vor , wobei Die Buttongruppe 2 zusätzlich gespiegelt wird.\\
