...
\title{Pflichtenheft: Lambda - Das Spiel, \\ Lost Here Too}
...
\begin{enumerate}
	\item \label{aufgabentyp:puzzle} Puzzle: Aufgabentyp bei dem an die vorgegebenen stellen Maschinen, Metallobjekte oder Maschinen-Cluster eingefügt werden müssen um einen \enquote{Lambdaausdruck} zu bauen der ein gewünschtes Ergebnis liefert oder einen gewünschten Endzustand hat.\\
...
\begin{telist}
	...
	\begin{itemize}
		\item Der Anwender befindet sich im Startfenster und drückt auf den \enquote{Benutzerverwaltungsbutton}. Diese Aktion führt den Benutzer zu einer neuen Anzeige, die seine bisherigen Profile beinhaltet.
		\item Durch Wischgewesen gelangt der Benutzer an das Ende der Liste, wo sich ein \enquote{+}-Zeichen befindet. Durch Drücken dieses Symbols wird ein neuer Dialog gestartet.
		\item In diesem Dialogfenster kann der Benutzer einen neuen Profilnamen angeben. Durch drücken des \enquote{Weiter}-Buttons gelangt der zu einem weitern Dialog.
	...
	\begin{itemize}
		\item Der Anweder befindet sich im Startfenster und drückt auf den \enquote{Benutzerverwaltungsbutton}. Diese Aktion führt den Benutzer zu einer neuen Anzeige, die seine bisherigen Profile beinhaltet.
