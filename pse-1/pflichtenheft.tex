...
\begin{falist}[resume]
	\item \label{fa:level} \textbf{Level} Ein \gls{gls:level} eine Aufgabe, mit gegebenem Ziel und einer Menge an Spielobjekten, die der Anwender an vorgegebenen Stellen platzieren muss.
	\item \label{fa:levelmenue} \textbf{Levelmenü} bietet eine Übersicht über alle \gls{gls:level} des Spiels (Musskriterium \ref{muss:5indilevel}). Diese sind unterteilt in abgeschlossene und nicht abgeschlossene Level.
    \begin{falist}
    ...
    \begin{falist}
    	...
    	\item \label{fa:button_ducken} \textbf{Drücken des Ducken Buttons} Durch das Drücken des Duckenbuttons wird die Größe der Spielerfigur verringert. Sobald der Anwender den Button los lässt kehrt die Figur zu ihrer ursprünglichen Größe zurück.
    \end{falist}
    ...
    \begin{falist}
    	...
    	\item \label{fa:wunsch_button_oben} \textbf{Wischgeste nach Oben} Der Anwender wischt mit seinem Finger über den Bildschirm nach oben. Dadurch führt die Spielfigur einen Sprung aus. Diese funktionale Anforderung ist kombinierbar mit \ref{fa:wunsch_button_rechts} und \ref{fa:wunsch_button_links}. Sollte der Anwender geduckt sein, richtet sich die Spielfigur wieder auf.
...
\begin{falist}[resume]
	...
	\item \label{fa:spielestatistiken} \textbf{Spielestatistiken} Das Spiel verfügt über Spielstatistiken, die Auskunft geben über das Verhalten des Spielers. \ref{produktdaten:spielestatistiken}
...
\begin{telist}
	...
	\begin{itemize}
		...
		\item Wurde ein Profil angelegt, öffnet sich die Einstellung
		...
		\item Nach dem Tutorial-Modus öffnet sich das Levelmenü und das erste \gls{gls:level} ist freigeschaltet 
	\end{itemize}
	...
	\begin{itemize}
		...
		\item Der Anwender wird durch die Tutorial-\gls{gls:level} geleitet, in denen ihm erklärt wird, wie er die Steuerung benutzen, die Elemente in die gewünschte Ablage bringen kann und wie genau die Maschinen die Elemente verarbeiten.
	...
	\begin{itemize}
		...
		\item In diesem Dialogfenster kann der Benutzer einen neuen Profilnamen angeben. Durch drücken des \enquote{Weiter}-Buttons gelangt er zu einem weiteren Dialog.
		\item In diesem Dialog kann er einen Charakter auswählen und auswählen, ob dieses Profil im Rechts- oder Linkshänder Modus* gespielt werden soll. Der Dialog wird durch Betätigen des \enquote{OK}-Buttons beendet.
	\end{itemize}
	...
	\begin{itemize}
		...
		\item Im Bearbeitungsbereich kann der Anwender den Namen, den Avatar und die Position der Steuerung (Rechts-oder Linkshänder- Modus)*  verändern.
	\end{itemize}
	...
	\begin{itemize}
		...
		\item Es erscheint eine vereinfachte Erklärung des Lambda-Kalküls, sowie eine Erläuterung zu den Zusammenhängen des Lambda-Kalküls und des Spiels.
	\end{itemize}
	...
	\begin{itemize}
		\item Der Anwender kann in den Spielestatistiken sehen, wie lange er gespielt, wie viele \gls{gls:level} er gelöst und welche Achievements* er bereits erreicht hat.
	\end{itemize}
...
\begin{telist}[resume]
	...
	\item Das Anlegen zweier Profile, die über den selben Namen verfügen, ist nicht gestattet. Sollte der Benutzer sich dazu entschließen ein Profil zu löschen, wird der Name wieder freigegeben und kann für ein neues Profil verwendet werden.
\end{telist}
