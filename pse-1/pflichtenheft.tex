...
\begin{description}
	...
	\begin{enumerate}
		\begin{minipage}{1\textwidth}
			...
			\includegraphics[width=\textwidth]{assets/Levelziel}
		\end{minipage}
		...
		\begin{minipage}{1\textwidth}
			...
			\includegraphics[width=\textwidth]{assets/Level1mA}
		\end{minipage}
		...
		\begin{minipage}{1\textwidth}
			...
			\includegraphics[width=\textwidth]{assets/LevelEnde}
		\end{minipage}
		...
		\begin{minipage}{1\textwidth}
			...
			\includegraphics[width=\textwidth]{assets/Levelhinweis}
		\end{minipage}
	\end{enumerate}
...
\clearpage
	...
	\item[Konstrukte:] \label{Levelaufbau:Konstrukte} Im folgenden sehen sie einige Konstrukte die in Leveln möglich sind, jeweils mit einer kurzen Erklärung.\\
		...
		\begin{minipage}{1\textwidth}
			...
			\includegraphics[width=\textwidth]{assets/LevelBsp1}
		\end{minipage}
		...
		\begin{minipage}{1\textwidth}
			...
			\includegraphics[width=\textwidth]{assets/LevelBsp1Out}\\
		\end{minipage}
		...
		\begin{minipage}{1\textwidth}
			...
			\includegraphics[width=\textwidth]{assets/LevelBsp2Out}\\
		\end{minipage}
		...
		\begin{minipage}{1\textwidth}
			...
			\includegraphics[width=\textwidth]{assets/LevelVerarbeitungBsp}\\
		...
		\begin{minipage}{1\textwidth}
			...
			\includegraphics[width=\textwidth]{assets/LevelBsp2Out1OC}\\
		\end{minipage}
	...
	\item[Auswertungsbeispiele:] \label{Levelaufbau:Asuwertungsbeispiele} Hier sehen sie ein Beispiel für den Ablauf einer Auswertung sowie Beispiel für einige andere Auswertungen.\\
		...
		\begin{minipage}{1\textwidth}
			...
			\includegraphics[width=\textwidth]{assets/AuswertungAmpelRot}
		\end{minipage}
		...
		\begin{minipage}{1\textwidth}
			...
			\includegraphics[width=\textwidth]{assets/AsuwertungAmpelGrun}
		\end{minipage}
...
} startet den Tutorial-Modus über das Level-Menü (Systemmodell \ref{appaufbau:Levelauswahl}) oder gelangt automatisch in diesen beim ersten Starten des Spiels mit einem neuen Profil.
